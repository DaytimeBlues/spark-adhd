...
const HomeScreen = ({navigation}: any) => {
  ...
  const modes = [
    {id: 'ignite', name: 'Ignite', icon: '≡ƒöÑ', desc: '5-min focus timer'},
    {id: 'fogcutter', name: 'Fog Cutter', icon: '≡ƒÆ¿', desc: 'Break tasks down'},
    {id: 'pomodoro', name: 'Pomodoro', icon: '≡ƒìà', desc: 'Classic timer'},
    {id: 'anchor', name: 'Anchor', icon: 'ΓÜô', desc: 'Breathing exercises'},
    {id: 'checkin', name: 'Check In', icon: '≡ƒôè', desc: 'Mood & energy'},
    {id: 'crisis', name: 'Crisis Mode', icon: '≡ƒåÿ', desc: 'Safety resources'},
  ];
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.streakContainer}>
            <Text style={styles.streakEmoji}>≡ƒöÑ</Text>
